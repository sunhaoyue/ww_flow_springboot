...
$(function(){
	...
	$("#list1").jqGrid({
		caption: '抄送表单列表',//表格标题
		url:'${ctx}/management/findCopyFlow.action',//请求路径
		...
		colNames:['文件编号', '类别', '主旨', '申请人', '提交人', '申请日期', '状态', '结案日期'],//表格列名称
		colModel :[ //列模型 
			{name:'formnum', index:'formnum', width:w*0.24, formatter:makeURL}, 
			{name:'flowTypeName', index:'flowTypeName',width:w*0.06, align:'center',formatter:renderFlowType},
			{name:'title', index:'title',width:w*0.22},			      
			...
			{name:'flowDisplayStatusName', index:'flowDisplayStatusName',width:w*0.06, align:'center'},
			{name:'endTime', index:'endTime',width:w*0.08, align:'center'}
		],
