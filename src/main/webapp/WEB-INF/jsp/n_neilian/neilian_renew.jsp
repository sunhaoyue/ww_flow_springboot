 ...
 <div class="bgc01">
   <div class="contentstyle"> 
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         ...
         <td align="left"><input name="createPerson.postName" type="text" class="width01 appInput" id="loginPostName" value="<s:property value="flow.createPerson.postName"/>" readonly="readonly" /></td>
         <td align="right">分机：</td>
         <td align="left"><input name="createPerson.compPhone" type="text" class="width01 appInput" id="loginPhone" value="<s:property value="flow.createPerson.compPhone"/>" readonly="readonly" /></td>
   ...
   <div class="contentstyle">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             <td><span class="width04">
               ...
               style="margin-top:-1px;margin-bottom:-1px;height:16px;line-height:14px;width:98%;" value="<s:property value="flow.createPerson.deptPath"/>" readonly="readonly" />
           ...
           <table width="140" border="0" cellpadding="0" cellspacing="0">
             <tr>
               ...
               <div class="rule-multi-radio">
                 <input name="content.secretLevel" type="radio" id="secretRadio" checked="checked" value="1" class="validate[required]"/>
               <label>一般</label>
       ...
       <!-- 公用明细 -->
   	   <jsp:include page="/pages/n_pub/flow_detail_forapply2.jsp"></jsp:include>
   	   <script type="text/javascript">
