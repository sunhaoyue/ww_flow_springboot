...
<div class="container" style="margin-top: 3px;">
   ...
   <div class="contentstyle">
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       ...
       <tr>
         ...
         <td><label>
           <input name="content.cash" type="text" id="textfield14" class="validate[required,custom[number]] appInput" 
       ...
       <!-- 公用明细 -->
   	   <jsp:include page="/WEB-INF/pages/n_pub/flow_detail_forapply2.jsp">
 ...
 <div class="bgc01">
   <!-- 附件列表 -->
   <jsp:include page="/WEB-INF/pages/n_pub/flow_attachment.jsp">
