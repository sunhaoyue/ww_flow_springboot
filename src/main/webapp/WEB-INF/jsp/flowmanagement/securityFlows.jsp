	...
	<table align="center" style="border: 0px solid;width: 100%;margin-bottom: 5px;">
		<tr>
			...
			<td width="24%" colspan="12">
				<input type="text" class="appInput" size="35" value="" id="searchSub" name="searchSub" />
			</td>
			<td width="6%" colspan="3" align="right">
				表单状态：
			</td>
...
$(function(){
	...
	$("#list1").jqGrid({
		caption: '机密表单列表',//表格标题
		url:'${ctx}/management/findSecurityFlow.action',//请求路径
		...
		colNames:['文件编号', '类别', '主旨', '申请人', '提交人', '申请时间', '状态'],//表格列名称
		colModel :[ //列模型 
			...
			{name:'title', index:'title',width:w*0.24},			      
			...
			{name:'flowDisplayStatusName', index:'flowDisplayStatusName',width:w*0.08, align:'center'}
		],
