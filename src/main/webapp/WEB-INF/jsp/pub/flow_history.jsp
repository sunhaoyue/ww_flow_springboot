<%@ page contentType="text/html; charset=utf-8" %>
    ...
    <table id="history"><tr ><td colspan="1" align="right" ></td></tr></table>
	<script>
	...
	function init_grid() {
	 		jQuery("#history").jqGrid({
				...
				height:'auto',//高度    
	 			...
	 			colModel:[ 
	 			     {name:'deptName',index:'deptName', width:160, align:'center', formatter:renderDeptName, 
	 				 ...
	 				 {name:'opinion',index:'opinion', width:250, 
		 			     cellattr: function(rowId, tv, rawObject, cm, rdata) {
		 			     	if (Number(rowId) == 1) {
			 			     	// ||flowStatus=='REJECT'
		 			     		if(showEndFlag){
	 				 ...
	 				 {name:'haveChildren',index:'haveChildren', width:150, hidden:true},
	 				 {name:'workId',index:'workId', width:150, hidden:true}	   ,
 			...
 			$.ajax({
			    ...
			    success: function (data,status ) {
			    	...
			    	showEndFlag = (flowStatus=='CANCEL'||flowStatus=='FINAL_DECISION_END'||flowStatus=='COPY_SEND'|| (flowStatus== 'REJECT' && data[0].processTime != ""));
