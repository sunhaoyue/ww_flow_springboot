	...
	<c:if test="${not empty param.flowType && param.flowType == 'neilian'}">
       ...
       <tr>
         <td valign="top">主&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;旨：&nbsp;<span class="text03">*</span></td>
          <td colspan="6"><textarea name="content.title" cols="45" rows="5" class="textarea01 appInput" id="title" style="width:680px;height:70px"><s:property value="flow.content.title"/></textarea></td>                
       </tr>
       <tr>
	               ...
	               if(leaderValue){
					   for(var i=0;i<leaderRadios.length;i++ ){
							if(leaderRadios[i].value==leaderValue){
								...
								if (($("#hid_HQFlg").val() == "true" && leaderValue.toLowerCase() == "unitleader") || leaderValue.toLowerCase() == "headleader"){
									$("#submitBoss").attr("disabled",false);
									$("#submitFBoss").attr("disabled",false);
									$("#chairman").attr("disabled",true);
								} else {
									if ($("#hid_sysFlg").val() == "X" && leaderValue.toLowerCase() == "centralleader"){
										$("#submitBoss").attr("disabled",false);
										$("#submitFBoss").attr("disabled",false);
										$("#chairman").attr("disabled",false);
									} else { 
										if ($("#hid_HQFlg").val() == "true" && $("#hid_sysFlg").val() == "F" && leaderValue.toLowerCase() == "centralleader"){
											//$("#submitBoss").attr("disabled",false);
											//$("#submitFBoss").attr("disabled",false);
										} else if ($("#hid_HQFlg").val() == "false" && $("#hid_sysFlg").val() == "F" && leaderValue.toLowerCase() == "reginleader"){
											//$("#submitBoss").attr("disabled",false);
											//$("#submitFBoss").attr("disabled",false);
										}
									}
       ...
       <tr>
         ...
         <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:3px;">
           <tr>
             <td><label>
             ...
             <td><div id="query3" class="button blue small" onclick="toOrganQuery()">查询组织</div></td>
           </tr>
         </table></td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:3px;">
           <tr>
             <td><label>
               <textarea name="copyDemo" cols="45" rows="3" class="textarea02 appInput" id="copyDemo" value="<s:property value="flow.copyDemo"/>"></textarea>
       ...
       <tr id="inner">
         ...
         <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:3px;">
           <tr>
             ...
             <td width="140"><div class="button blue small" onclick="addInnerhuiban()">添&nbsp;加</div>
             <div id="query5" class="button blue small" onclick="toOrganQuery()">查询组织</div>             
           </tr>
         </table></td>
       </tr>
       <tr id="innerNames">
         <td colspan="7" valign="top"><textarea name="innerhuibanNames" cols="45" rows="5" class="textarea01 appInput" id="innerhuibanNames" readonly></textarea>
         	<div class="button blue small" style="margin-right:5px;float: right;" onclick="removeInnerhuiban()">清&nbsp;除</div>
         </td>
        </tr>
       <tr>
         <td valign="top">建&nbsp;议&nbsp;方&nbsp;案：</td>
         <td colspan="6"><textarea name="content.scheme" cols="45" rows="3" class="textarea01 appInput" id="scheme"></textarea></td>
