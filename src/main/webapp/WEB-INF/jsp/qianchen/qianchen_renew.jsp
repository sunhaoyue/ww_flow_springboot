     ...
     <tr>
       ...
       <td align="right"><table border="0" cellspacing="0" cellpadding="0">
         <tr>
           ...
           <td><label>
             <input name="formNum" type="text" class="text02" id="formNum" value="<s:property value="flow.formNum"/>"/>
           </label></td>
         </tr>
       </table></td>
     </tr>
   ...
   <div class="contentstyle">                      
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
       <tr>
         ...
         <td align="left"><input name="createPerson.postName" type="text" class="width02" id="loginPostName" value="<s:property value="flow.createPerson.postName"/>" readonly="readonly" /></td>
         <td align="right">分机：</td>
         <td align="left"><input name="createPerson.compPhone" type="text" class="width03" id="loginPhone" value="<s:property value="flow.createPerson.compPhone"/>" readonly="readonly" /></td>
       ...
       <tr>
         ...
         <td colspan="7"><label class="width04">
           <input name="textfield7" type="text" class="width0" id="textfield7" value="<s:property value="flow.createPerson.deptPath"/>" readonly="readonly" />
         </label></td>
        </tr>
     </table>
   </div>
