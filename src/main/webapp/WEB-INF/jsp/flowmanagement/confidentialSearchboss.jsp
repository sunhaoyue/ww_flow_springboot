...
$(function(){
	...
	//$.fn.zTree.init($("#treeOrg"), setting, null);
	  ...
	  $("#list1").jqGrid({
	    ...
	    url:'${ctx}/management/confSearchbossWorks.action',//请求路径
...
jQuery("#export").click(function(){
	...
	document.getElementById("advancedForm").action="${ctx}/management/confbossExportWorks.action";				
