	...
	<c:if test="${not empty param.flowType && param.flowType == 'neilian'}">
		...
		<td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
		    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="text03" id="leaderTable">
             ...
             <td align="right">
             	<label><input name="selfconfirm" type="checkbox" value="1" id="selfconfirm" checked/></label>本人确认
             	<c:if test="${not empty param.flowType && param.flowType == 'qiancheng'}">
       ...
       <tr>
         ...
         <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             ...
             <td><div id="query3" class="button01" onclick="toOrganQuery('huiban')">查询组织</div></td>
           </tr>
         </table></td>
       </tr>
       <tr>
       ...
       <tr>
         ...
         <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             <td><label>
               <textarea name="copyDemo" cols="45" rows="3" class="textarea02" id="copyDemo"></textarea>
             </label></td>
             <td>&nbsp;</td>
           </tr>
         </table></td>
       ...
       <tr id="inner">
         ...
         <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             ...
             <td width="140">
             <div class="button02" onclick="addInnerhuiban()">添&nbsp;加</div>
       ...
       <tr id="innerNames">
		<td valign="top"></td>	
         <td colspan="6" valign="top"><textarea name="innerhuibanNames" cols="45" rows="5" class="textarea01" id="innerhuibanNames" style="width:580px" readonly></textarea>
       ...
       <tr>
         ...
         <td colspan="6"><textarea name="content.scheme" cols="45" rows="5" class="textarea01" id="scheme" style="width:580px;height:120px"></textarea></td>
       </tr>
