...
<link id="skin" rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/jquery-ui-1.8.21.custom.css" />
	...
	<ul><table id="userList"></table></td></ul> 
     <script>
		...
		jQuery("#userList").jqGrid({ 
 		...
 		$.ajax({
			type: "POST",
			url: '<%=request.getContextPath()%>/user/loadJoinUsers.action',
			dataType:'json',
